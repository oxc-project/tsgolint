...
func TestPreferReadonlyParameterTypesRule(t *testing.T) {
	...
	rule_tester.RunRuleTester(fixtures.GetRootDir(), "tsconfig.minimal.json", t, &PreferReadonlyParameterTypesRule, []rule_tester.ValidTestCase{
		...
		{Code: "\n        class PrivateMutable {\n          private values = new Map<string, unknown>();\n        }\n        function f(value: Readonly<PrivateMutable>): void {}\n\n        class PrivateReadonly {\n          private readonly values = new Map<string, unknown>();\n        }\n        function g(value: Readonly<PrivateReadonly>): void {}\n      ", Options: rule_tester.OptionsFromJSON[PreferReadonlyParameterTypesOptions](`{"checkParameterProperties":true,"ignoreInferredTypes":false,"treatMethodsAsReadonly":true}`)},
		{Code: "\n        class PrivateMutableArray {\n          private values: string[] = [];\n        }\n        function f(value: Readonly<PrivateMutableArray>): void {}\n      ", Options: rule_tester.OptionsFromJSON[PreferReadonlyParameterTypesOptions](`{"treatMethodsAsReadonly":true}`)},
		{Code: "\n        type MyType = {\n          readonly prop: string;\n          method(): string;\n        };\n        function foo(arg: MyType) {}\n      ", Options: rule_tester.OptionsFromJSON[PreferReadonlyParameterTypesOptions](`{"treatMethodsAsReadonly":true}`)},
		{Code: "\n        class Foo {\n          method() {}\n        }\n        function foo(arg: Foo) {}\n      ", Options: rule_tester.OptionsFromJSON[PreferReadonlyParameterTypesOptions](`{"treatMethodsAsReadonly":true}`)},
		{Code: "\n        interface Foo {\n          method(): void;\n        }\n        function foo(arg: Foo) {}\n      ", Options: rule_tester.OptionsFromJSON[PreferReadonlyParameterTypesOptions](`{"treatMethodsAsReadonly":true}`)},
		...
		{Code: "class PrivateMutable { private values = new Map<string, unknown>(); }\nfunction f(value: PrivateMutable): void {}", Errors: []rule_tester.InvalidTestCaseError{{MessageId: "shouldBeReadonly", Line: 2}}, Options: rule_tester.OptionsFromJSON[PreferReadonlyParameterTypesOptions](`{"treatMethodsAsReadonly":true}`)},
	})
}
