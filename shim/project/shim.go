...
//go:linkname ConfigFileRegistryBuilder_FindOrAcquireConfigForFile github.com/microsoft/TypeScript/tsc/internal/project.(*ConfigFileRegistryBuilder).FindOrAcquireConfigForFile
...
//go:linkname ConfigFileRegistryBuilder_ComputeConfigFileName github.com/microsoft/TypeScript/tsc/internal/project.(*ConfigFileRegistryBuilder).ComputeConfigFileName
