...
function generateConfig(
    files: string[],
    rules: readonly ((typeof ALL_RULES)[number] | { name: (typeof ALL_RULES)[number]; options: Record<string, unknown> })[] = ALL_RULES,
    options?: {
...
describe('TSGoLint E2E Snapshot Tests', () => {
    ...
    it('should work with the old version of the headless payload', async () => {
        function generateV1HeadlessPayload(files: string[], rules: readonly (typeof ALL_RULES)[number][] = ALL_RULES): string {
            const config = {
